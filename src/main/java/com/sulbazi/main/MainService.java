...
public class MainService {
	...
	public void mainPage(Model model) {
        ...
        Map<String, UserDTO> profile = new HashMap<String, UserDTO>();// 각 user_id에 맞는 프로필 사진을 담을 리스트

        // 2. 각 user_id에 맞는 user_photo 조회
